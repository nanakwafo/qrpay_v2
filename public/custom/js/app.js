...
$(document).ready(function () {
  var dashboard = {
    ...
    init: function init() {
      ...
      this.cacheDom();
      this.bindEvents();
      this.getdata(this.initstartDate(), this.initendDate(), 'day', this.platformId).then(function (data) {
        console.log(data); // show loader
    ...
    chartDateByDayActive: function chartDateByDayActive() {
      ...
      this.getdata(this.date_start, this.date_end, 'day', this.platformId).then(function (data) {
        console.log(data); // show loader
      })["catch"](function (error) {// console.log(error)
        //show error message
      });
    },
    chartDateByWeekActive: function chartDateByWeekActive() {
      this.$chartDateBy.removeClass('active');
      ...
      this.date_start = this.$chartDateStart.val();
      this.date_end = this.$chartDateEnd.val();
      this.getdata(this.date_start, this.date_end, 'week', this.platformId).then(function (data) {
        console.log(data); // show loader
      })["catch"](function (error) {// console.log(error)
        //show error message
      });
    },
    chartDateByMonthActive: function chartDateByMonthActive() {
      this.$chartDateBy.removeClass('active');
      ...
      this.date_start = this.$chartDateStart.val();
      this.date_end = this.$chartDateEnd.val();
      this.getdata(this.date_start, this.date_end, 'month', this.platformId).then(function (data) {
        console.log(data); // show loader
      })["catch"](function (error) {// console.log(error)
        //show error message
      });
    },
    getdata: function getdata(date_start, date_end, type, platformId) {
...
$(document).ready(function () {
  var account = {
    ...
    bindEvents: function bindEvents() {
      ...
      this.$qrcodgenerateBtnupload_form.on('submit', function (event) {
        ...
        $.ajax({
          ...
          error: function error(_error) {
            if (_error.responseJSON.errors.collectionFile[0] !== "undefined" && _error.responseJSON.errors.collectionFile[0]) toastr.error(_error.responseJSON.errors.collectionFile[0], _error.responseJSON.message);
          }
        });
      });
    ...
    addAmountAction: function addAmountAction() {
    ...
    removeAmountAction: function removeAmountAction() {
...
$(document).ready(function () {
  var getReport = function getReport(paramPlatformId, paramQrcodeId) {
  ...
  var qrreports = {
    ...
    init: function init() {
      ...
      this.cacheDom();
      this.bindEvents();
      getReport(this.platformId, ''); // this.getPieChart(this.platformId).then((data) => {
      //     console.log(data)
      //     // show loader
      // }).catch((error) => {
      //     // console.log(error)
    ...
    cacheDom: function cacheDom() {
      this.$qrcode_type = $('.qrcode_type'); // this.$chartPie = $('#chartPie');
    },
    bindEvents: function bindEvents() {
...
__webpack_require__(/*! ./payvendor */ "./resources/js/payvendor.js");

__webpack_require__(/*! ./dashboard */ "./resources/js/dashboard.js");

__webpack_require__(/*! ./qrcode */ "./resources/js/qrcode.js");

__webpack_require__(/*! ./reports */ "./resources/js/reports.js");
})();
