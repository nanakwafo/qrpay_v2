            ...
            <div>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                  ...
                  <li class="breadcrumb-item active" aria-current="page" href="/dashboard/{{$platformId}}">Sales Monitoring</li>
                </ol>
              </nav>
          ...
          <div class="row row-xs">
            <div class="col-sm-6 col-lg-3">
              <div class="card card-body">
                <h6 class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Overall Donation</h6>
                <div class="d-flex d-lg-block d-xl-flex align-items-end">
                    @if(is_null($userOnboardStatus) || $userOnboardStatus == false)
                        <h3 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1">0.00 $NZD</h3>
                    @else
                        <h3 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1">{{\App\Helpers\Stripeuser::getOverallDanations($platformId) . ' $NZD'}}</h3>
                    @endif
              ...
              <div class="card card-body">
                ...
                <div class="d-flex d-lg-block d-xl-flex align-items-end">
                    ...
                    @else
                        ...
                        <h3 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1">{{\App\Helpers\Stripeuser::getAvialableBalance($platformId) . ' $NZD'}}</h3>
                    @endif
            ...
            <div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0">
              <div class="card card-body">
                <h6 class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Pending Balance</h6>
                <div class="d-flex d-lg-block d-xl-flex align-items-end">
                    @if(is_null($userOnboardStatus) || $userOnboardStatus == false)

                        <h3 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1">0.00 $NZD </h3>
                    @else
                        <h3 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1">{{\App\Helpers\Stripeuser::getBalance($platformId) . ' $NZD'}}</h3>
                    @endif
            ...
            <div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0">
              <div class="card card-body">
                <h6 class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Total Number of Donations</h6>
                <div class="d-flex d-lg-block d-xl-flex align-items-end">
              ...
              <div class="card ht-100p">
                ...
                <ul class="list-group list-group-flush tx-13">
                    @php
                        $i=1;
                    @endphp
                    @foreach($recentTransaction as $r)
                  <li class="list-group-item d-flex pd-sm-x-20">
                    ...
                    <div class="pd-sm-l-10">
                      ...
                      <small class="tx-12 tx-color-03 mg-b-0">{{$r->created_at}}</small>
                    </div>
                    <div class="mg-l-auto text-right">
                      <p class="tx-medium mg-b-0">+ {{$r->amount}}</p>
